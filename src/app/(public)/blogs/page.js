...
export default function Blogs() {
  const router = useRouter();
    ...
    return (
      <>
        <h2 className="text-center text-5xl font-bold w-full mt-24 text-red-500">Jekk.com</h2>
        <p className="text-center margin-0 mx-auto w-3/6	">
        asa design website profesional dan berpengalaman menangani 700+ perusahaan ternama. Bangun digital online presence 
        </p>
